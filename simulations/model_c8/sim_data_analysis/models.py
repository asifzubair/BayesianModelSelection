...
class PapaModel:
    ...
    def __init__(self):
        ...
        inFile = np.loadtxt('inputs-outputs_sim.txt', delimiter='\t')
...
class PapaModelA6(PapaModel):
    ...
    def predict(self, parms):
        return PapaModel.predict(self, np.append(parms, [parms[4], parms[4]]))
...
class PapaModel_B_Kr(PapaModel):
    ...
    def predict(self, parms):
        alpha, D, Co, Ns, K, K1, K2, K3, K4 = parms
        K=10**(K - self.ab)
        K1=10**(K1 - self.ab)
        K2=10**(K2 - self.ab)
        K3=10**(K3 - self.ab)
        ...
        params = [alpha, K, K1, K2, K3, K4, Co, Ns]
...
class PapaModel_B_Kr7(PapaModel_B_Kr):
    ...
    def predict(self, parms):
        return PapaModel_B_Kr.predict(self, np.append(parms, [parms[4], parms[4]]))

class PapaModel_B_Kr8_node(PapaModel_B_Kr):
    
    def __init__(self):
        self.name = "B_Kr8_node"
        PapaModel.__init__(self)

    def predict(self, parms):
        return PapaModel_B_Kr.predict(self, np.append(parms[:7], [parms[4], parms[7]]))
...
class PapaModel_B_Kr8(PapaModel_B_Kr):
    ...
    def predict(self, parms):
        return PapaModel_B_Kr.predict(self, np.append(parms, parms[7]))

class PapaModel_B_Kr9(PapaModel_B_Kr):
